...
public class PrevoziTrazimFragment extends Fragment implements PrevozAdapter.PrevozAdapterOnClickHandler,  LoaderManager.LoaderCallbacks<String> {
    ...
    public PrevoziTrazimFragment() {

    }

    public static PrevoziTrazimFragment newInstance(MyRunnablePar onScroll) {
        PrevoziTrazimFragment fragment = new PrevoziTrazimFragment();
